...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //byte[] flagsByteArray = new byte[2];
        //flagsByteArray[0] = Byte.parseByte("00000001");
        //flagsByteArray[1] = Byte.parseByte("00000000");
        ...
        System.out.println("\nbyte1 of flags: " + flagsByteArray[0] + " byte2 of flags: " + flagsByteArray[1]);
